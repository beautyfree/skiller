...
export default function SearchInput({
  ...
  return (
    <div className="relative group">
      <input
        ref={inputRef}
        className="h-8 w-full rounded-xl border border-border bg-card/85 dark:bg-white/[0.04] backdrop-blur-md px-4 pr-8 text-sm outline-none transition-all duration-200 placeholder:text-muted-foreground/60 focus:border-primary/35 focus:ring-2 focus:ring-primary/15 focus:bg-card dark:focus:bg-white/[0.06]"
