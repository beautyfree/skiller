const en = {
  ...
  sidebar: {
    ...
    skills: "All Skills",
    agents: "Agents",
    agentSkillsTooltip: "{{direct}} direct · {{dotagents}} .agents",
    agentSkillsTooltipWithOtherShared: "{{direct}} direct · {{dotagents}} .agents · {{other}} other shared",
  ...
  dashboard: {
    ...
    skillsAvailable: "{{count}} skills available",
		protectLibrary: "Set up Agent Library",
		remoteLibraryHint: "Choose where to keep it when you are ready",
		openSync: "Open Agent Library",
  ...
  skills: {
    ...
    filterDirect: "Direct installs",
    filterInheritedOnly: ".agents",
    ...
    via: "Source: {{name}}",
	sharedDirectory: ".agents",
	sharedLibrarySkillHint: "Stored in ~/.agents/skills. Detected agents are listed when they are configured to read this shared library or have a direct link.",
	agentLinksLabel: "Available to agents ({{count}})",
	sharedNoAgentLinks: "No detected agent is configured to read this shared library yet.",
    symlink: "symlink",
    ...
    updateFromSource: "Review update",
    updating: "Updating...",
    ...
    batchUnavailableNoDirect: "This skill has no direct installation to remove.",
    batchUnavailableCollectionChild: "This skill is managed by its collection.",
    batchConfirmTitle: "Uninstall {{count}} skills?",
    batchConfirmBody:
      "This will remove the selected skills' direct installations from every agent.",
    batchConfirmMore: "+ {{count}} more",
    batchConfirmInheritedHint:
      "Skills provided by inherited source links may remain visible after their direct installations are removed.",
    confirmBatchUninstall: "Uninstall {{count}} skills",
    batchUninstallDone: "Uninstalled {{count}} skills from all agents.",
    batchUninstallPartial: "Uninstalled {{removed}} skills; {{failed}} failed.",
    batchUninstallFailed: "Could not uninstall the selected skills.",
    ...
    removeFromSharedLibrary: "Remove from .agents",
    bulkLabel: "Bulk:",
    ...
    bulkCopyNoCandidates:
      "{{source}} has no skills you could copy here (skills inherited from .agents don't count — only direct installs).",
    bulkCopyAllPresent:
      "Nothing to copy — {{target}} already sees all {{count}} skills (likely via ~/.agents/skills).",
    ...
    removeFromAgentHintBoth: "direct + .agents copy — both go",
    ...
    removeFromAgentConfirmBoth:
      "\"{{skill}}\" is installed on {{agent}} two ways:\n  • Directly in {{agent}}'s own folder\n  • Via ~/.agents/skills (read by {{preservedCount}} other agent(s): {{preservedNames}})\n\nSkiller will remove the direct copy AND detach the .agents copy (copying it into those other agents first so they keep it). After this {{agent}} won't see the skill at all.\n\nFuture .agents updates won't reach the copied-out versions. Continue?",
    ...
    detachConfirm:
      "\"{{skill}}\" lives in ~/.agents/skills — every agent that reads from it sees it.\n\nTo remove it only from {{agent}}, Skiller will first copy the skill into: {{preservedNames}} (so those agents keep it), then delete the .agents copy. {{agent}} will no longer see it.\n\nAfter detach, future .agents updates won't reach the copied ones. Continue?",
    ...
    confirmRemoveSharedTitle: "Remove from .agents?",
    confirmRemoveSharedBody:
      "This removes this skill from ~/.agents/skills. Any direct copies of the same skill on this computer are removed too.",
  ...
  marketplace: {
    ...
    detail: "Detail",
    installed: "Installed",
    inDotagents: "In .agents",
    availableFromDotagents: "Available from ~/.agents/skills",
    installAll: "Install to .agents",
    installAllHint: "Saves one copy in ~/.agents/skills, then links it to compatible detected agents.",
    installToProject: "Install to project",
