const en = {
  ...
  sidebar: {
    ...
    skills: "All Skills",
    agents: "Agents",
    agentSkillsTooltip: "{{name}} — {{direct}} own · {{inherited}} from .agents",
  ...
  skills: {
	...
	sharedLibrarySkillHint: "Stored in ~/.agents/skills. Agents are listed only when a real link exists.",
	agentLinksLabel: "Agent links ({{count}})",
	sharedNoAgentLinks: "No agent links. This skill stays in .agents.",
    symlink: "symlink",
