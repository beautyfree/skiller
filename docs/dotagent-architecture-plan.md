...
- [ ] Publish package provenance, checksums, SBOM, changelog, and migration guide. The complete byte-reproducible artifact set and retry-safe permanent GitHub Release path are generated, independently verified, tamper/extra-asset tested, and retained by successful non-publishing workflow run `30824175165`; npm/GitHub publication remains intentionally disabled until version/visibility and the release itself are explicitly approved.
