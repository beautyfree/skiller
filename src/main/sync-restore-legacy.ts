 ...
 */
export function createLegacySyncRestorePlan(workspacePath: string, canonicalSkillsPath: string): SyncRestorePlan {
 ...
 */
export function applyLegacySyncRestorePlan(plan: SyncRestorePlan, selectedIds: string[], profileId?: string): void {
