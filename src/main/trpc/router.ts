...
export function createAppRouter(ctx: {
  ...
  return t.router({
    ...
    dotagents_scope_overview: proc.query(() => h.dotagents_scope_overview()),
    dotagents_scope_migration_preview: proc.input(anyIn).query(({ input }) => h.dotagents_scope_migration_preview(input)),
    dotagents_scope_migration_apply: proc.input(anyIn).mutation(({ input }) => h.dotagents_scope_migration_apply(input)),
    dotagents_scope_composition_preview: proc.input(anyIn).query(({ input }) => h.dotagents_scope_composition_preview(input)),
    dotagents_scope_composition_apply: proc.input(anyIn).mutation(({ input }) => h.dotagents_scope_composition_apply(input)),
    dotagents_scope_composition_undo_preview: proc.query(() => h.dotagents_scope_composition_undo_preview()),
    dotagents_scope_composition_undo_apply: proc.input(anyIn).mutation(({ input }) => h.dotagents_scope_composition_undo_apply(input)),
    dotagents_resource_pick_source: proc.input(anyIn).mutation(({ input }) => h.dotagents_resource_pick_source(input)),
    dotagents_resource_adopt_preview: proc.input(anyIn).query(({ input }) => h.dotagents_resource_adopt_preview(input)),
    dotagents_resource_adopt_apply: proc.input(anyIn).mutation(({ input }) => h.dotagents_resource_adopt_apply(input)),
