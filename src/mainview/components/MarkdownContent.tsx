  ...
  return (
    <div className="select-text">
      <ReactMarkdown
        ...
        // Headings
        h1: ({ children }) => (
          <h1 className="text-lg font-[590] mt-4 mb-2 first:mt-0">
            {children}
          </h1>
        ),
        h2: ({ children }) => (
          <h2 className="text-base font-[590] mt-4 mb-2 first:mt-0">
            {children}
          </h2>
        ),
        h3: ({ children }) => (
          <h3 className="text-sm font-[590] mt-3 mb-1.5 first:mt-0">
            {children}
          </h3>
        ),
        h4: ({ children }) => (
